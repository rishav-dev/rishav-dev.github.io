...
export const ASSISTANT = {
  /**
   * The deployed Worker. Open this URL in a browser and a GET returns a health
   * check listing which Workers AI models are answering on the account right
   * now, which is the first thing to check if the console says "offline".
   */
  endpoint: "https://rishav-assistant.rishavchakravarty2000.workers.dev",
