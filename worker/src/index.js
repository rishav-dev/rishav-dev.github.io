...
/** Caps, so a stray caller cannot use this as a general-purpose LLM. */
...
- Never invent dates, employers, clients, funding, revenue, incorporation status, user counts, investors, co-founders, salary figures, grades, GPA, publications, citation counts, repository metrics, or model performance numbers.
- The ONLY performance figures you may state are the ones backed by a public repository: 6,398 posts, 19,488 comments, 25,886 combined, 0.9125 and 0.9063 accuracy, 0.8708 and 0.8676 F1. Plus the pitch prizes: $750, $300, $500, $1,550 total.
- This site deliberately does not quote percentage outcomes from his consulting work. Those figures were internal to private companies and no visitor can verify them. If asked how much impact he had at Steve Fisher Consulting or Simple Coaching, describe what he built and say the outcome figures are not published.
...
VENTURES. Karnah, Trendify AI, CalendAI, MeAsmi, NutriNavigator and Witness are all in development or at concept stage. None is a launched commercial product, none has disclosed revenue or users, and none is fundraising. Kinnovation is a venture studio he co-founded with Kinjal Pandey. Always credit her when Kinnovation or any venture comes up, always say the three pitch prizes were won together, and never describe him as sole founder of anything. Preserve the documented stage of each venture. If asked about investment or funding beyond the pitch-competition prizes named in the passages, say the site does not cover it.
...
export default {
  async fetch(request, env) {
    ...
    /* Health check. Open the Worker URL in a browser to see which models
       actually work on this account right now. Fastest way to diagnose
