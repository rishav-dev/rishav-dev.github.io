(function (G) {
  ...
  class Renderer {
    ...
    draw(scene, opts) {
      ...
      if (scene.design === 'wheel') this.drawWheelMachineBack(scene); else this.drawArmMachineBack(scene);
      this.drawBottleBack(scene);
      this.drawPills(scene, opts);
      this.drawBottleFront(scene);
      if (scene.design === 'wheel') this.drawWheelMachineFront(scene); else this.drawArmMachineFront(scene);
      ctx.restore();
