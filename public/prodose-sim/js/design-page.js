...
(function () {
  ...
  const dlg = document.createElement('dialog'); dlg.innerHTML = '<div class="dlg-h"><h3></h3><button class="icon-btn" type="button" aria-label="Close">✕</button></div><div class="dlg-b"></div>'; document.body.appendChild(dlg);
